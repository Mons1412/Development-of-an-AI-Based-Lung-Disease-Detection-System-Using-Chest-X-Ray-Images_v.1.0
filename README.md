...
This project is our **Graduation Project**, developed to research and build an **AI-based system for detecting and classifying lung diseases from chest X-ray images**.
...
> **Note:** This system is developed for educational and research purposes and is **not intended to replace professional medical diagnosis**.
